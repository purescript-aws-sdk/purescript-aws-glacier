...
abortMultipartUpload = Request.request service method  where
    service = Request.ServiceName "Glacier"
...
abortVaultLock = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "abortVaultLock"
...
addTagsToVault = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "addTagsToVault"
...
completeVaultLock = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "completeVaultLock"
...
createVault = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "createVault"
...
deleteArchive = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "deleteArchive"
...
deleteVault = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "deleteVault"
...
deleteVaultAccessPolicy = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "deleteVaultAccessPolicy"
...
deleteVaultNotifications = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "deleteVaultNotifications"
...
describeVault = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "describeVault"
...
getDataRetrievalPolicy = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "getDataRetrievalPolicy"
...
getJobOutput = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "getJobOutput"
...
getVaultAccessPolicy = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "getVaultAccessPolicy"
...
getVaultLock = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "getVaultLock"
...
getVaultNotifications = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "getVaultNotifications"
...
initiateJob = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "initiateJob"
...
initiateMultipartUpload = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "initiateMultipartUpload"
...
initiateVaultLock = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "initiateVaultLock"
...
listProvisionedCapacity = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "listProvisionedCapacity"
...
listTagsForVault = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "listTagsForVault"
...
listVaults = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "listVaults"
...
purchaseProvisionedCapacity = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "purchaseProvisionedCapacity"
...
removeTagsFromVault = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "removeTagsFromVault"
...
setDataRetrievalPolicy = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "setDataRetrievalPolicy"
...
setVaultAccessPolicy = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "setVaultAccessPolicy"
...
setVaultNotifications = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "setVaultNotifications"
...
uploadArchive = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "uploadArchive"
...
uploadMultipartPart = Request.request service method  where
    service = Request.ServiceName "Glacier"
    method = Request.MethodName "uploadMultipartPart"
