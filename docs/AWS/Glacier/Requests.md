## Module AWS.Glacier.Requests

#### `abortMultipartUpload`

``` purescript
abortMultipartUpload :: forall eff. Service -> AbortMultipartUploadInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
abortVaultLock :: forall eff. Service -> AbortVaultLockInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
addTagsToVault :: forall eff. Service -> AddTagsToVaultInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
completeVaultLock :: forall eff. Service -> CompleteVaultLockInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteArchive :: forall eff. Service -> DeleteArchiveInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteVault :: forall eff. Service -> DeleteVaultInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteVaultAccessPolicy :: forall eff. Service -> DeleteVaultAccessPolicyInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
deleteVaultNotifications :: forall eff. Service -> DeleteVaultNotificationsInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
removeTagsFromVault :: forall eff. Service -> RemoveTagsFromVaultInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
setDataRetrievalPolicy :: forall eff. Service -> SetDataRetrievalPolicyInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
setVaultAccessPolicy :: forall eff. Service -> SetVaultAccessPolicyInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
...
``` purescript
setVaultNotifications :: forall eff. Service -> SetVaultNotificationsInput -> Aff (exception :: EXCEPTION | eff) NoOutput
```
